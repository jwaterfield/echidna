...
class DBIsotope(object):
    ...
    def __init__(self, name, atm_weight_iso, atm_weight_nat, abundance,
                 phase_space, matrix_element, loading=None, outer_radius=None,
                 scint_density=None):
    ...
    def get_n_atoms(self, loading=None, scint_density=None, target_mass=None,
                    scint_mass=None, outer_radius=None):
...
def test():
    ...
    a = 139.60788303840818


    # Check get_n_atoms for 0.3% loading
    ...
    expected = 1.1388e+27  # Calculated - A Back 2015-10-29
    result, message = physics_tests.test_function_float(
    ...
    fv_correction = (6. / 3.5) ** 3
    expected = roi_counts / roi_efficiency * fv_correction 
    # /y SNO+-doc-2593v8 - adjusted from roi and FV
    activity = 50.4
    result, message = physics_tests.test_function_float(
    ...
    # /y SNO+-doc-2593v8 - adjusted from roi and FV
    counts = expected
    expected = roi_counts / roi_efficiency * fv_correction / livetime
    result, message = physics_tests.test_function_float(
    ...
    expected = counts  # Num decays, SNO+-doc-2593v8 (3 sig CL @ 5 y livetime)
    # eV, SNO+-doc-2593v8 (3 sigma @ 5 y livetime)
